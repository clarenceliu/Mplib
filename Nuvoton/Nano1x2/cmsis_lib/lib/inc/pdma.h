 ...
 * $Revision: 5 $
 * $Date: 13/12/16 4:27p $
 * @brief    Nano1x2 series PDMA driver header file
 *
 * @note
...
/*---------------------------------------------------------------------------------------------------------*/
#define PDMA_WIDTH_8        0x00100000UL            /*!<DMA Transfer Width 8-bit */
#define PDMA_WIDTH_16       0x00080000UL            /*!<DMA Transfer Width 16-bit */
...
#define PDMA_PWM0_TX        0x00000019UL            /*!<DMA Connect to PWM0 TX */
#define PDMA_PWM1_TX        0x0000001AUL            /*!<DMA Connect to PWM1 TX */
#define PDMA_PWM2_TX        0x0000001BUL            /*!<DMA Connect to PWM2 TX */
#define PDMA_PWM3_TX        0x0000001CUL            /*!<DMA Connect to PWM3 TX */
 ...
 */
#define PDMA_GET_INT_STATUS()   ((uint32_t)(PDMAGCR->ISR))
 ...
 */
#define PDMA_GET_CH_INT_STS(u32Ch)   ((uint32_t)*((__IO uint32_t *)((uint32_t)&PDMA1->ISR + (uint32_t)((u32Ch-1)*0x100))))
