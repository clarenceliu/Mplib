...
void WEAK  ACMP01_IRQHandler(void); 
void WEAK  ACMP23_IRQHandler(void);
...
#pragma weak ACMP01_IRQHandler = Default_Handler 
#pragma weak ACMP23_IRQHandler = Default_Handler
