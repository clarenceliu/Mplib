...
#ifndef __TMPM36B_GPIO_H
#define __TMPM36B_GPIO_H
...
/** @brief :The maximum number of the Function Register
  * Note for porting:
  * If functiong register 6 is the maximum number in 
  * all the GPIO port,then define FRMAX (6U)
  */
#define FRMAX  (6U)             /*Port L has function register 6 */
