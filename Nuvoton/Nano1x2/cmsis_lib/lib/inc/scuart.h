 ...
 * $Revision: 6 $
 * $Date: 14/01/14 5:34p $
 * @brief    Nano1x2 series Smartcard UART mode (SCUART) driver header file
 *
 * @note
...
#define SCUART_PARITY_NONE    (0)                                       /*!< Set SCUART transfer with no parity   */
#define SCUART_PARITY_ODD     (SC_UACTL_OPE_Msk | SC_UACTL_PBDIS_Msk)   /*!< Set SCUART transfer with odd parity  */
#define SCUART_PARITY_EVEN    (SC_UACTL_OPE_Msk)                        /*!< Set SCUART transfer with even parity */
