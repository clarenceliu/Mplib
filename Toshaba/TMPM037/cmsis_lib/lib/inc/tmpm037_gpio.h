...
#ifndef __TMPM037_GPIO_H
#define __TMPM037_GPIO_H
...
#define IS_GPIO_PORT(param)             ((param) <= GPIO_PG)    /*parameter checking for port number */
...
#endif                          /* defined(__TMPM037_GPIO_H) */
