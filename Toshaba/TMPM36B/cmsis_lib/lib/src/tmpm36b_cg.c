...
#define CG_WUP_COUNTER_MASK                  ((uint32_t)0xFFF7FFF7)
#define CG_OSCCR_WRITE0_MASK                 ((uint32_t)0xFFFFCF3F)
#define CG_OSCCR_WRITE1_MASK                 ((uint32_t)0x00000030)

#define CG_PLLSET_VALUE_MASK                 ((uint32_t)0x0000FFFE)

#define CG_STBY_MODE_MASK                    ((uint32_t)0xFFFFFFF8)
#define CG_STBY_WRITE0_MASK                  ((uint32_t)0xFFF3FFFF)
#define CG_NMIFLG_MASK                       ((uint32_t)0xFFFFFFF0)
#define CG_RESET_FLAG_MASK                   ((uint32_t)0xFFFFFF80)
...
#ifdef TSB_M36BFY
#define CG_FPLL_8M_MULTIPLY_6_VALUE          (0x00007117UL<<1U)
#define CG_FPLL_8M_MULTIPLY_10_VALUE         (0x000071A6UL<<1U)
#define CG_FPLL_10M_MULTIPLY_8_VALUE         (0x0000711EUL<<1U)
#define CG_FPLL_12M_MULTIPLY_4_VALUE         (0x0000610FUL<<1U)
#define CG_FPLL_12M_MULTIPLY_6_VALUE         (0x00006195UL<<1U)
#define CG_FPLL_16M_MULTIPLY_3_VALUE         (0x00006A8BUL<<1U)
#define CG_FPLL_16M_MULTIPLY_5_VALUE         (0x00007292UL<<1U)
#define CG_FPLL_VALUE_MAX                    ((uint32_t)0x00000007)
#elif defined (TSB_M36BF10 )
#define CG_FPLL_8M_MULTIPLY_8_VALUE          (0x0000789FUL<<1U)
#define CG_FPLL_8M_10M_MULTIPLY_6_VALUE      (0x00007817UL<<1U)
#define CG_FPLL_10M_MULTIPLY_4_VALUE         (0x0000780FUL<<1U)
#define CG_FPLL_12M_MULTIPLY_5_VALUE         (0x00007993UL<<1U)
#define CG_FPLL_12M_16M_MULTIPLY_4_VALUE     (0x0000790FUL<<1U)
#define CG_FPLL_16M_MULTIPLY_3_VALUE         (0x0000710BUL<<1U)
#define CG_FPLL_VALUE_MAX                    ((uint32_t)0x00000006)
#endif

#define WARM_UP_SEL_OSC_INT_HIGH             ((uint32_t)0x00000000)
#define WARM_UP_SEL_OSC_EXT_HIGH             ((uint32_t)0x00080000)
#define WARM_UP_SEL_OSC_EXT_LOW              ((uint32_t)0x00080008)
...
#define CG_OSC_OFD_SET                       ((uint32_t)0x00000400)
#define CG_OSC_OFD_CLEAR                     ((uint32_t)0xFFFFFBFF)
...
#ifdef TSB_M36BFY
static CG_FpllValue fpllValue_table[CG_FPLL_VALUE_MAX] = {
    CG_FPLL_8M_MULTIPLY_6,
    CG_FPLL_8M_MULTIPLY_10,
    CG_FPLL_10M_MULTIPLY_8,
    CG_FPLL_12M_MULTIPLY_4,
    CG_FPLL_12M_MULTIPLY_6,
    CG_FPLL_16M_MULTIPLY_3,
    CG_FPLL_16M_MULTIPLY_5,
};

static uint32_t numFpllValue_table[CG_FPLL_VALUE_MAX] = {
    CG_FPLL_8M_MULTIPLY_6_VALUE,
    CG_FPLL_8M_MULTIPLY_10_VALUE,
    CG_FPLL_10M_MULTIPLY_8_VALUE,
    CG_FPLL_12M_MULTIPLY_4_VALUE,
    CG_FPLL_12M_MULTIPLY_6_VALUE,
    CG_FPLL_16M_MULTIPLY_3_VALUE,
    CG_FPLL_16M_MULTIPLY_5_VALUE,
};
#elif defined (TSB_M36BF10 )
static CG_FpllValue fpllValue_table[CG_FPLL_VALUE_MAX] = {
    CG_FPLL_8M_MULTIPLY_8,
    CG_FPLL_8M_10M_MULTIPLY_6,
    CG_FPLL_10M_MULTIPLY_4,
    CG_FPLL_12M_MULTIPLY_5,
    CG_FPLL_12M_16M_MULTIPLY_4,
    CG_FPLL_16M_MULTIPLY_3,
};

static uint32_t numFpllValue_table[CG_FPLL_VALUE_MAX] = {
    CG_FPLL_8M_MULTIPLY_8_VALUE,
    CG_FPLL_8M_10M_MULTIPLY_6_VALUE,
    CG_FPLL_10M_MULTIPLY_4_VALUE,
    CG_FPLL_12M_MULTIPLY_5_VALUE,
    CG_FPLL_12M_16M_MULTIPLY_4_VALUE,
    CG_FPLL_16M_MULTIPLY_3_VALUE,
};
#endif
/** @} */
...
void CG_SetWarmUpTime(CG_WarmUpSrc Source, uint16_t Time)
{
    ...
    case CG_WARM_UP_SRC_OSC_EXT_LOW:
        /* Check the parameters */
        assert_param(IS_CG_WARM_UP_TIME_LOW(Time));
    ...
    regval &= CG_OSCCR_WRITE0_MASK;     /* CGOSCCR bit 13, 12, 7, 6 write "0" */
    regval |= CG_OSCCR_WRITE1_MASK;     /* CGOSCCR bit 5, 4 write "1" */
    TSB_CG->OSCCR = regval;
}
...
/**
  ...
  *   This parameter can be one of the following values:
  * For TMPM36BFY
  *   CG_FPLL_8M_MULTIPLY_6, CG_FPLL_8M_MULTIPLY_10,
  *   CG_FPLL_10M_MULTIPLY_8, CG_FPLL_12M_MULTIPLY_4,
  *   CG_FPLL_12M_MULTIPLY_6, CG_FPLL_16M_MULTIPLY_3,
  *   CG_FPLL_16M_MULTIPLY_5
  * For TMPM36BF10
  *   CG_FPLL_8M_MULTIPLY_8, CG_FPLL_8M_10M_MULTIPLY_6,
  *   CG_FPLL_10M_MULTIPLY_4, CG_FPLL_12M_MULTIPLY_5,
  *   CG_FPLL_12M_16M_MULTIPLY_4, CG_FPLL_16M_MULTIPLY_3
  * @retval Success or not
  *   The value returned can be one of the following values:
  *   SUCCESS or ERROR
  */
Result CG_SetFPLLValue(CG_FpllValue NewValue)
{
    ...
    if (pllon == ENABLE) {
        ...
        for (i = 0U; i < CG_FPLL_VALUE_MAX; i++) {
            if (NewValue == fpllValue_table[i]) {
                TSB_CG->PLLSEL = numFpllValue_table[i];
                retval = SUCCESS;
                break;
            } else {
                /* Do nothing */
...
/**
  ...
  *   CG_FPLL_10M_MULTIPLY_8, CG_FPLL_12M_MULTIPLY_4,
  *   CG_FPLL_12M_MULTIPLY_6, CG_FPLL_16M_MULTIPLY_3,
  *   CG_FPLL_16M_MULTIPLY_5, CG_FPLL_MULTIPLY_UNKNOWN
  * For TMPM36BF10
  *   CG_FPLL_8M_MULTIPLY_8, CG_FPLL_8M_10M_MULTIPLY_6,
  *   CG_FPLL_10M_MULTIPLY_4, CG_FPLL_12M_MULTIPLY_5,
  *   CG_FPLL_12M_16M_MULTIPLY_4, CG_FPLL_16M_MULTIPLY_3,
...
#ifdef TSB_M36BFY
    CG_FpllValue i = CG_FPLL_8M_MULTIPLY_6;
#elif defined (TSB_M36BF10 )
    CG_FpllValue i = CG_FPLL_8M_MULTIPLY_8;
#endif

    pllsel &= CG_PLLSET_VALUE_MASK;

#ifdef TSB_M36BFY
    for (i = CG_FPLL_8M_MULTIPLY_6; i < CG_FPLL_VALUE_MAX; i++) {
#elif defined (TSB_M36BF10 )
    for (i = CG_FPLL_8M_MULTIPLY_8; i < CG_FPLL_VALUE_MAX; i++) {
#endif
        if (pllsel == numFpllValue_table[i]) {
            retval = i;
            break;
        } else {
            /* Do nothing */
...
void CG_SetSTBYMode(CG_STBYMode Mode)
{
    ...
    regval &= CG_STBY_WRITE0_MASK;      /* CGSTBYCR bit 19, 18 write "0"  */
...
/**
  ...
  *   CG_INT_SRC_C, CG_INT_SRC_D,
  *   CG_INT_SRC_RTC, CG_INT_SRC_RMCRX
                             ...
                             CG_INTActiveState ActiveState, FunctionalState NewState)
{
    ...
    } else if (INTSource == CG_INT_SRC_RMCRX) {
        assert_param(IS_CG_INT_RMCRX_ACTIVE_STATE(ActiveState));
    } else {
        /* Do nothing */
    }
    ...
    case 2U:                   /* IMCGC */
        regval.byte4 = TSB_CG->IMCGC;
        regval.byte[j] &= 0x8CU;
        regval.byte[j] |= ActiveState;
        TSB_CG->IMCGC = regval.byte4;
        regval.byte[j] |= NewState;
        TSB_CG->IMCGC = regval.byte4;
        break;
    case 3U:                   /* IMCGD */
        regval.byte4 = TSB_CG->IMCGD;
        regval.byte[j] &= 0x8CU;
        regval.byte[j] |= ActiveState;
        TSB_CG->IMCGD = regval.byte4;
        regval.byte[j] |= NewState;
        TSB_CG->IMCGD = regval.byte4;
        break;
    default:
...
/**
  * @brief  Enable or disable the oscillation of internal high-speed oscillator mode for OFD.
  * @param  NewState: New state of internal high-speed oscillator
  *   This parameter can be one of the following values:
  *   DISABLE or ENABLE
  * @retval None
  */
void CG_SetInternalOscForOFD(FunctionalState NewState)
{
    ...
    tmp = TSB_CG->OSCCR;
    if (NewState == ENABLE) {
        /* Set CGOSCCR<XEN3> to internal high-speed ocillator for OFD */
        tmp |= CG_OSC_OFD_SET;
    } else {
        /* Clear CGOSCCR<XEN3> to disable internal high-speed ocillator for OFD */
        tmp &= CG_OSC_OFD_CLEAR;
    }

    tmp &= CG_OSCCR_WRITE0_MASK;        /* CGOSCCR bit 13, 12, 7, 6 write "0" */
    tmp |= CG_OSCCR_WRITE1_MASK;        /* CGOSCCR bit 5, 4 write "1" */
    TSB_CG->OSCCR = tmp;
}
 ...
 /**
   ...
   *   CG_FC_PERIPH_UDMACA, CG_FC_PERIPH_UDMACB, CG_FC_PERIPH_EBIF,
   *   CG_FC_PERIPH_TMRB0, CG_FC_PERIPH_TMRB1, CG_FC_PERIPH_TMRB2,
   *   CG_FC_PERIPH_TMRB3, CG_FC_PERIPH_TMRB4, CG_FC_PERIPH_TMRB5,
   *   CG_FC_PERIPH_TMRB6, CG_FC_PERIPH_TMRB7, CG_FC_PERIPH_SIO_UART0,
   *   CG_FC_PERIPH_SIO_UART1, CG_FC_PERIPH_SIO_UART2, CG_FC_PERIPH_SIO_UART3,
   *   CG_FC_PERIPH_UART4, CG_FC_PERIPH_UART5, CG_FC_PERIPH_I2C_SIO0,
   *   CG_FC_PERIPH_I2C_SIO1, CG_FC_PERIPH_I2C_SIO2, CG_FC_PERIPH_SSP0,
   *   CG_FC_PERIPH_SSP1, CG_FC_PERIPH_SSP2, CG_FC_PERIPH_RMC,
   *   CG_FC_PERIPH_MPT0, CG_FC_PERIPH_MPT1, CG_FC_PERIPH_MPT2,
   *   CG_FC_PERIPH_MPT3, CG_FC_PERIPH_PMD, CG_FC_PERIPH_ENC,
   *   CG_FC_PERIPH_LVD, CG_FC_PERIPH_TRACECLK, CG_FC_PERIPH_ALL         
...
/**
  * @brief  Enable or disable low-speed oscillator (fs) for RMC & RTC
  * @param  NewState: oscillator is enabled or disabled
  *   This parameter can be one of the following values:
  *   DISABLE or ENABLE
  * @retval None
