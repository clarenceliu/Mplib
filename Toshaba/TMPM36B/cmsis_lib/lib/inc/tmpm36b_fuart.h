...
#ifndef __TMPM36B_FUART_H
#define __TMPM36B_FUART_H
...
/** @defgroup FUART_Exported_Constants
  * @{
  */
#define FUART4                                 TSB_UART4
#define FUART5                                 TSB_UART5
#define TSB_FUART_TypeDef                      TSB_UART_TypeDef

#define IS_FUART_PERIPH(param)                 (((param) == FUART4) || \
                                                ((param) == FUART5))

#define IS_FUART_DMA_PERIPH(param)             (((param) == FUART4) || \
                                                ((param) == FUART5))
