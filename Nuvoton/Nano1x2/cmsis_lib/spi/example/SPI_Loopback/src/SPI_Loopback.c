 ...
 * $Revision: 2 $
 * $Date: 13/12/11 3:39p $
 * @brief    Nano1X2 Series SPI Driver Sample Code
 *
 * @note
...
void SysInit(void)
{
    ...
    SYS->PB_H_MFP = (SYS_PB_H_MFP_PB10_MFP_SPI1_MOSI1 | SYS_PB_H_MFP_PB11_MFP_SPI0_MISO1 | SYS_PB_H_MFP_PB12_MFP_SPI0_MOSI0 | SYS_PB_H_MFP_PB13_MFP_SPI0_MISO0
                     | SYS_PB_H_MFP_PB14_MFP_SPI0_SCLK | SYS_PB_H_MFP_PB15_MFP_SPI0_SS0);

    /* Set multi function pin for SPI1 */
    SYS->PA_H_MFP = (SYS_PA_H_MFP_PA12_MFP_SPI1_MISO0 | SYS_PA_H_MFP_PA13_MFP_SPI1_MOSI0 | SYS_PA_H_MFP_PA14_MFP_SPI1_SCLK | SYS_PA_H_MFP_PA15_MFP_SPI1_SS0);
