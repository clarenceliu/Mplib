...
#ifndef __TMPM36B_IGBT_H
#define __TMPM36B_IGBT_H
...
#define IGBT_CLSYN_CH_UPCN_ENABLE               ((uint8_t)0x80)
...
#define IS_IGBT_CLSYN_VALUE(param)               (((param) == IGBT_CLSYN_CH_UPCN_ENABLE) || \
                                                 ((param) == ~((uint32_t) IGBT_CLSYN_CH_UPCN_ENABLE)))
