...
#define CR_TBINSEL_CLEAR       ((uint32_t)0xFFFFFFFB)
...
#define MOD_TBCPM_CLEAR_TMRB   ((uint32_t)0xFFFFFFCF)
...
void TMRB_Enable(TSB_TB_TypeDef * TBx)
{
    ...
    if ((TBx == TSB_TB_MPT0) || (TBx == TSB_TB_MPT1) || (TBx == TSB_TB_MPT2)
        || (TBx == TSB_TB_MPT3)) {
...
/**
  ...
  *   or TMRB_MASK_OVERFLOW_INT or combine of them.
  * @retval None
  */
...
/**
  * @brief  Control the external inputs.
  * @param  TBx: Select the TMRB channel.
  *   This parameter can be one of the following values:
  *   TSB_TB0, TSB_TB1, TSB_TB2, TSB_TB3, TSB_TB4, TSB_TB5, TSB_TB6, TSB_TB7.
  * @retval None
...
void TMRB_SetExtInput(TSB_TB_TypeDef * TBx)
{
    ...
    /* Check the parameters */
    assert_param(IS_TMRB_TMRB_PERIPH(TBx));
...
#endif                          /* defined(__TMPM36B_TMRB_H) */
