 ...
 *******************************************************************************
 * @file    main.c
 * @brief   The application functions of UART0 FIFO demo for the TOSHIBA
...
uint8_t TxBuffer[] = "TMPM36B1";
uint8_t RxBuffer[BufSize] = { 0U };
uint8_t TxBuffer1[] = "TMPM36B2";
...
void SIO_Configuration(TSB_SC_TypeDef * SCx)
{
    if (SCx == TSB_SC0) {
        ...
        TSB_PL->CR |= GPIO_BIT_2;
        TSB_PL->FR5 |= GPIO_BIT_2;
        TSB_PL->FR5 |= GPIO_BIT_1;
        TSB_PL->IE |= GPIO_BIT_1;
    } else if (SCx == TSB_SC3) {
        TSB_PB->CR |= GPIO_BIT_0;
        TSB_PB->FR3 |= GPIO_BIT_0;
        TSB_PB->FR3 |= GPIO_BIT_1;
        TSB_PB->IE |= GPIO_BIT_1;
    }
}
