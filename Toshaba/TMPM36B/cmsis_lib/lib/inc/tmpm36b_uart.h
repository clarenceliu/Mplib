...
#ifndef __TMPM36B_UART_H
#define __TMPM36B_UART_H
...
#define SIO_CLK_BAUDRATE            ((uint32_t)0x00000000)
#define SIO_CLK_SCLKINPUT           ((uint32_t)0x00000001)
#define IS_SIO_CLK_SEL(param)       (((param) == SIO_CLK_BAUDRATE) || \
...
#define SIO_BR_CLOCK_T1             ((uint32_t)0x00000000)
#define SIO_BR_CLOCK_T4             ((uint32_t)0x00000010)
#define SIO_BR_CLOCK_T16            ((uint32_t)0x00000020)
#define SIO_BR_CLOCK_T64            ((uint32_t)0x00000030)
#define IS_SIO_BR_CLOCK(param)      (((param) == SIO_BR_CLOCK_T1) || \
                                     ((param) == SIO_BR_CLOCK_T4) || \
                                     ((param) == SIO_BR_CLOCK_T16) || \
                                     ((param) == SIO_BR_CLOCK_T64))
