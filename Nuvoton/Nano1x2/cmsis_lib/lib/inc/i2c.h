 ...
 * $Revision: 6 $
 * $Date: 14/01/20 9:14a $
 * @brief    Nano1x2 series I2C driver header file
 *
 * @note
...
/**
  ...
  * @return none
  */
#define I2C_STOP(i2c) ( (i2c)->CON = ((i2c)->CON & ~I2C_CON_I2C_STS_Msk) | I2C_CON_STOP_Msk )
...
/**
  ...
  * @return none
  */
#define I2C_WAIT_READY(i2c) while(!((i2c)->INTSTS & I2C_INTSTS_INTSTS_Msk))
