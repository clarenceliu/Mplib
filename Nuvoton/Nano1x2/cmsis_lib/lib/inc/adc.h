 ...
 * @version  V1.00
 * $Revision: 8 $
 * $Date: 14/03/06 11:35a $
 * @brief    NANO1X2 series ADC driver header file
 *
 * @note
...
/**
  ...
  * \hideinitializer
  */
#define ADC_GET_CONVERSION_DATA(adc, u32ChNum) ( *(__IO uint32_t *)( &ADC->RESULT0 + (1*u32ChNum)) & ADC_RESULT_RSLT_Msk)
