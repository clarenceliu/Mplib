 ...
 * $Revision: 9 $
 * $Date: 14/03/31 9:39a $
 * @brief    Nano1x2 series RTC driver source file
 *
 * @note
 ...
 *
 *  @param    i32FrequencyX10000    Specify the RTC clock X10000, ex: 327736512 means 32773.6512.
 *
 *  @return   None
 *
 */
