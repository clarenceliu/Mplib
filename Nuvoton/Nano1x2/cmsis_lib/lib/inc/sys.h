...
* $Revision: 20 $
* $Date: 14/01/14 3:19p $
* @brief    Nano1X2 Series system control header file.
*
* @note
...
#define SYS_IPRSTCTL2_PWM1      ((uint32_t)0x00200000)      /*!<PWM 1 reset */
...
#define SYS_PA_L_MFP_PA5_MFP_SC2_RST      (4UL<<SYS_PA_L_MFP_PA5_MFP_Pos)     /*!<PA5 Pin Function - SmartCard0 Power pin */
#define SYS_PA_L_MFP_PA5_MFP_I2C1_SDA     (5UL<<SYS_PA_L_MFP_PA5_MFP_Pos)     /*!<PA5 Pin Function - I2C1 data I/O pin */
#define SYS_PA_H_MFP_PA5_MFP_SPI1_SS0     (6UL<<SYS_PA_L_MFP_PA5_MFP_Pos)     /*!<PA5 Pin Function - SPI1 1st chip selection */
...
#define SYS_PA_H_MFP_PA15_MFP_I2C_DAT     (4UL<<SYS_PA_H_MFP_PA15_MFP_Pos)    /*!<PA15 Pin Function - I2C1 data I/O pin */
...
#define SYS_PA_H_MFP_PA13_MFP_I2C0_DAT    (5UL<<SYS_PA_H_MFP_PA13_MFP_Pos)    /*!<PA13 Pin Function - I2C0 data I/O pin*/
#define SYS_PA_H_MFP_PA13_MFP_SPI1_MOSI0  (6UL<<SYS_PA_H_MFP_PA13_MFP_Pos)    /*!<PA13 Pin Function - SPI1 MOSI[0] */
...
#define SYS_PA_H_MFP_PA12_MFP_I2C1_SCL    (5UL<<SYS_PA_H_MFP_PA12_MFP_Pos)    /*!<PA12 Pin Function - I2C1 clock pin */
#define SYS_PA_H_MFP_PA12_MFP_SPI1_MISO0  (6UL<<SYS_PA_H_MFP_PA12_MFP_Pos)    /*!<PA12 Pin Function - SPI1 MOSI[0] */
...
#define SYS_PA_H_MFP_PA10_MFP_SC0_DAT     (4UL<<SYS_PA_H_MFP_PA10_MFP_Pos)    /*!<PA10 Pin Function - SmartCard0 DATA */
...
#define SYS_PB_L_MFP_PB7_MFP_CD           (4UL<<SYS_PB_L_MFP_PB7_MFP_Pos)     /*!<PB7 Pin Function - SmartCard0 card detect */
...
#define SYS_PB_L_MFP_PB5_MFP_SPI2_MOSI1   (6UL<<SYS_PB_L_MFP_PB5_MFP_Pos)     /*!<PB5 Pin Function - MOSI[1] */
...
#define SYS_PB_L_MFP_PB3_MFP_TMR2_CAP     (2UL<<SYS_PB_L_MFP_PB3_MFP_Pos)     /*!<PB3 Pin Function - Timer2 capture event */
#define SYS_PB_L_MFP_PB3_MFP_I2C_DAT      (5UL<<SYS_PB_L_MFP_PB3_MFP_Pos)     /*!<PB3 Pin Function - I2C0 data I/O pin */
...
#define SYS_PB_L_MFP_PB2_MFP_TMR3_CAP     (2UL<<SYS_PB_L_MFP_PB2_MFP_Pos)     /*!<PB2 Pin Function - Timer3 capture event */
#define SYS_PA_L_MFP_PB2_MFP_I2C0_SCL     (5UL<<SYS_PB_L_MFP_PB2_MFP_Pos)     /*!<PB2 Pin Function - I2C0 clock pin */
...
#define SYS_PB_H_MFP_PB12_MFP_TMR0_EXT    (2UL<<SYS_PB_H_MFP_PB12_MFP_Pos)    /*!<PB12 Pin Function - Timer0 external counter input */
...
#define SYS_PB_H_MFP_PB11_MFP_TMR1_EXT        (2UL<<SYS_PB_H_MFP_PB11_MFP_Pos)/*!<PB11 Pin Function - Timer1 external event input */
...
#define SYS_PB_H_MFP_PB11_MFP_LCD_S27V        (8UL<<SYS_PB_H_MFP_PB11_MFP_Pos)/*!<PB11 Pin Function - LCD SEG 27 */

#define SYS_PB_H_MFP_PB10_MFP_GPB10           (0UL<<SYS_PB_H_MFP_PB10_MFP_Pos)/*!<PB10 Pin Function - GPIOB[10] */
#define SYS_PB_H_MFP_PB10_MFP_SPI1_MOSI1      (6UL<<SYS_PB_H_MFP_PB10_MFP_Pos)/*!<PB10 Pin Function - SPI1 MOSI[1] */
#define SYS_PB_H_MFP_PB10_MFP_UART1_RX        (7UL<<SYS_PB_H_MFP_PB10_MFP_Pos)/*!<PB10 Pin Function - UART1 RX */
#define SYS_PB_H_MFP_PB10_MFP_S24             (8UL<<SYS_PB_H_MFP_PB10_MFP_Pos)/*!<PB10 Pin Function - LCD SEG 24 */
#define SYS_PB_H_MFP_PB10_MFP_S28             (8UL<<SYS_PB_H_MFP_PB10_MFP_Pos)/*!<PB10 Pin Function - LCD SEG 28 */
...
#define SYS_PB_H_MFP_PB8_MFP_TMR0_EXT         (2UL<<SYS_PB_H_MFP_PB8_MFP_Pos) /*!<PB8 Pin Function - Timer0 external counter input */
...
#define SYS_PC_L_MFP_PC0_MFP_LCD_S11      (7UL<<SYS_PC_L_MFP_PC0_MFP_Pos)     /*!<PC0 Pin Function - LCD SEG 11 */
#define SYS_PC_L_MFP_PC0_MFP_LCD_S18      (7UL<<SYS_PC_L_MFP_PC0_MFP_Pos)     /*!<PC0 Pin Function - LCD SEG 18 */
#define SYS_PC_L_MFP_PC0_MFP_LCD_S24      (7UL<<SYS_PC_L_MFP_PC0_MFP_Pos)     /*!<PC0 Pin Function - LCD SEG 24 */
...
#define SYS_PC_H_MFP_PC11_MFP_I2C1_SDA    (5UL<<SYS_PC_L_MFP_PC11_MFP_Pos)    /*!<PC11 Pin Function - I2C1 data I/O pin */
...
#define SYS_PC_H_MFP_PC10_MFP_I2C1_SCL    (5UL<<SYS_PC_L_MFP_PC10_MFP_Pos)    /*!<PC10 Pin Function - I2C1 clock pin */
...
#define SYS_PC_H_MFP_PC9_MFP_LCD_S29      (8UL<<SYS_PC_H_MFP_PC9_MFP_Pos)     /*!<PC9 Pin Function - LCD SEG 9 */
#define SYS_PC_H_MFP_PC9_MFP_LCD_S9       (8UL<<SYS_PC_H_MFP_PC9_MFP_Pos)     /*!<PC9 Pin Function - LCD SEG 2 */
...
#define SYS_PD_L_MFP_PD7_MFP_LCD_S3       (8UL<<SYS_PD_L_MFP_PD7_MFP_Pos)     /*!<PD7 Pin Function - LCD SEG 3 */
...
#define SYS_PD_H_MFP_PD13_MFP_EINT1       (0UL<<SYS_PD_H_MFP_PD13_MFP_Pos)    /*!<PD13 Pin Function - External interrupt 1 input pin */
...
#define SYS_PD_H_MFP_PD12_MFP_TMR1_EXT    (2UL<<SYS_PD_H_MFP_PD12_MFP_Pos)    /*!<PD12 Pin Function - Timer1 external counter input */
#define SYS_PD_H_MFP_PD12_MFP_PWM0_CH0    (3UL<<SYS_PD_H_MFP_PD12_MFP_Pos)    /*!<PD12 Pin Function - PWM0 Channel0 output */
#define SYS_PD_H_MFP_PD12_MFP_LCD_DH2     (8UL<<SYS_PD_H_MFP_PD12_MFP_Pos)    /*!<PD12 Pin Function - LCD DH2 */
...
#define SYS_PD_H_MFP_PD11_MFP_LCD_DH1     (8UL<<SYS_PD_H_MFP_PD11_MFP_Pos)    /*!<PD11 Pin Function - LCD DH1 */
...
#define SYS_PD_H_MFP_PD10_MFP_LCD_COM0    (7UL<<SYS_PD_H_MFP_PD10_MFP_Pos)    /*!<PD10 Pin Function - LCD COM0 */
...
#define SYS_PD_H_MFP_PD9_MFP_LCD_COM1     (7UL<<SYS_PD_H_MFP_PD9_MFP_Pos)     /*!<PD9 Pin Function - LCD COM1 */
...
#define SYS_PD_H_MFP_PD8_MFP_LCD_COM2     (7UL<<SYS_PD_H_MFP_PD8_MFP_Pos)     /*!<PD8 Pin Function - LCD COM2 */
...
#define SYS_PE_L_MFP_PE3_MFP_SC1_CD       (4UL<<SYS_PE_L_MFP_PE3_MFP_Pos)     /*!<PE3 Pin Function - SPI0 1st slave select pin */
...
#define SYS_PF_L_MFP_PF4_MFP_CKO_1HZ      (9UL<<SYS_PF_L_MFP_PF4_MFP_Pos)     /*!<PF4 Pin Function - 1Hz clock output */
...
#define SYS_PF_L_MFP_PF3_MFP_HXT_IN     (0xFUL<<SYS_PF_L_MFP_PF3_MFP_Pos)     /*!<PF3 Pin Function - HXT IN */
...
#define SYS_PF_L_MFP_PF2_MFP_HXT_OUT    (0xFUL<<SYS_PF_L_MFP_PF2_MFP_Pos)     /*!<PF2 Pin Function - HXT OUT */

#define SYS_PF_L_MFP_PF1_MFP_GPF1         (0UL<<SYS_PF_L_MFP_PF1_MFP_Pos)     /*!<PF1 Pin Function - GPIOF[1] */
#define SYS_PF_L_MFP_PF1_MFP_TMR2_EXT     (2UL<<SYS_PF_L_MFP_PF1_MFP_Pos)     /*!<PF1 Pin Function - Timer2 external counter input */
#define SYS_PF_L_MFP_PF1_MFP_ICE_CLK    (0xFUL<<SYS_PF_L_MFP_PF1_MFP_Pos)     /*!<PF1 Pin Function - ICE CLOCK */

#define SYS_PF_L_MFP_PF0_MFP_GPF0         (0UL<<SYS_PF_L_MFP_PF0_MFP_Pos)     /*!<PF0 Pin Function - GPIOF[0] */
#define SYS_PF_L_MFP_PF0_MFP_TMR3_EXT     (2UL<<SYS_PF_L_MFP_PF1_MFP_Pos)     /*!<PF0 Pin Function - Timer3 external counter input */
#define SYS_PF_L_MFP_PF0_MFP_ICE_DAT    (0xFUL<<SYS_PF_L_MFP_PF0_MFP_Pos)     /*!<PF0 Pin Function - ICE DATA */
...
/** @addtogroup NANO1X2_SYS_EXPORTED_FUNCTIONS SYS Exported Functions
  @{
*/
#define SYS_CLEAR_BOD_INT_FLAG()        (SYS->BODSTS |= SYS_BODSTS_BOD_INT_Msk)        /*!< This macro clear Brown-out interrupt flag */    
#define SYS_DISABLE_BOD25()             (SYS->BODCTL |= SYS_BODCTL_BOD25_EN_Msk)       /*!< This macro disable Brown-out 2.5V detect function */
#define SYS_ENABLE_BOD25()              (SYS->BODCTL &= ~SYS_BODCTL_BOD25_EN_Msk)      /*!< This macro enable Brown-out 2.5V detect function */
#define SYS_DISABLE_BOD20()             (SYS->BODCTL |= SYS_BODCTL_BOD20_EN_Msk)       /*!< This macro disable Brown-out 2.0V detect function */
#define SYS_ENABLE_BOD20()              (SYS->BODCTL &= ~SYS_BODCTL_BOD20_EN_Msk)      /*!< This macro enable Brown-out 2.0V detect function */
#define SYS_DISABLE_BOD17()             (SYS->BODCTL |= SYS_BODCTL_BOD17_EN_Msk)       /*!< This macro disable Brown-out 1.7V detect function */
#define SYS_ENABLE_BOD17()              (SYS->BODCTL &= ~SYS_BODCTL_BOD17_EN_Msk)      /*!< This macro enable Brown-out 1.7V detect function */												
#define SYS_GET_BOD_INT_FLAG()          (SYS->BODSTS & SYS_BODSTS_BOD_INT_Msk)         /*!< This macro get Brown-out detect interrupt flag */								
#define SYS_GET_BOD25_OUTPUT()          (SYS->BODSTS & SYS_BODSTS_BOD25_OUT_Msk)       /*!< This macro get Brown-out 2.5V detector output status */
#define SYS_GET_BOD20_OUTPUT()          (SYS->BODSTS & SYS_BODSTS_BOD20_OUT_Msk)       /*!< This macro get Brown-out 2.5V detector output status */
#define SYS_GET_BOD17_OUTPUT()          (SYS->BODSTS & SYS_BODSTS_BOD17_OUT_Msk)       /*!< This macro get Brown-out 2.5V detector output status */
#define SYS_DISABLE_BOD25_RST()         (SYS->BODCTL &= ~SYS_BODCTL_BOD25_RST_EN_Msk)  /*!< This macro enable Brown-out 2.5V detect interrupt function */
#define SYS_ENABLE_BOD25_RST()          (SYS->BODCTL |= SYS_BODCTL_BOD25_RST_EN_Msk)   /*!< This macro enable Brown-out 2.5V detect reset function */
#define SYS_DISABLE_BOD20_RST()         (SYS->BODCTL &= ~SYS_BODCTL_BOD20_RST_EN_Msk)  /*!< This macro enable Brown-out 2.0V detect interrupt function */
#define SYS_ENABLE_BOD20_RST()          (SYS->BODCTL |= SYS_BODCTL_BOD20_RST_EN_Msk)   /*!< This macro enable Brown-out 2.0V detect reset function */
#define SYS_DISABLE_BOD17_RST()         (SYS->BODCTL &= ~SYS_BODCTL_BOD17_RST_EN_Msk)  /*!< This macro enable Brown-out 1.7V detect interrupt function */
#define SYS_ENABLE_BOD17_RST()          (SYS->BODCTL |= SYS_BODCTL_BOD17_RST_EN_Msk)   /*!< This macro enable Brown-out 1.7V detect reset function */
#define SYS_IS_BOD_RST()                (SYS->RST_SRC & SYS_RST_SRC_RSTS_BOD_Msk)      /*!< This macro get previous reset source is from Brown-out detect reset */
#define SYS_IS_CPU_RST()                (SYS->RST_SRC & SYS_RST_SRC_RSTS_CPU_Msk)      /*!< This macro get previous reset source is from Low-Voltage-Reset */
#define SYS_IS_POR_RST()                (SYS->RST_SRC & SYS_RST_SRC_RSTS_POR_Msk)      /*!< This macro get previous reset source is from Power-on Reset */
#define SYS_IS_RSTPIN_RST()             (SYS->RST_SRC & SYS_RST_SRC_RSTS_RESET_Msk)    /*!< This macro get previous reset source is from reset pin reset */
#define SYS_IS_SYSTEM_RST()             (SYS->RST_SRC & SYS_RST_SRC_RSTS_MCU_Msk)      /*!< This macro get previous reset source is from system reset */
#define SYS_IS_WDT_RST()                (SYS->RST_SRC & SYS_RST_SRC_RSTS_WDT_Msk)      /*!< This macro get previous reset source is from window watch dog  reset */
#define SYS_DISABLE_POR()               (SYS->PORCTL = 0x5AA5)                         /*!< This macro disable Power-on Reset function */
#define SYS_ENABLE_POR()                (SYS->PORCTL = 0)                              /*!< This macro enable Power-on Reset function */
#define SYS_CLEAR_RST_SOURCE(u32RstSrc) (SYS->RST_SRC | u32RstSrc )                    /*!< This macro clear reset source flag */
