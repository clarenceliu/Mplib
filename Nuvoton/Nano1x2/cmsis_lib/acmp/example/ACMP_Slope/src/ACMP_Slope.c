/******************************************************************************
 * @file     main.c
 * @brief    Nano1xx ACMP Slope Sample code
 * @version  1.0.1
 ...
 ACMP_Slope (void)
{
    ...
    uint32_t charge[CHARGE_NUM]= {ACMP_CMP0MODCR_CH_DIS_PINSEL_PA14,ACMP_CMP0MODCR_CH_DIS_PINSEL_PA3};
    ...
    ACMP_Open(ACMP,0,ACMP_CMPCR_CN0_CRV|1,ACMP_CMPCR_CMP_HYSTERSIS_DISABLE);
    ACMP_SetSlopeConv(ACMP_TIMER01,ACMP_CMP0MODCR_TMR_TRI_LV_FALLING,ACMP_CMP0CR_CPP0SEL_PA4,ACMP_CMP0MODCR_CH_DIS_PINSEL_PA14);

    while(1) {
        for(j=0; j<CHARGE_NUM; j++) {
            ACMP_SetSlopeConv(ACMP_TIMER01,ACMP_CMP0MODCR_TMR_TRI_LV_FALLING,ACMP_CMP0CR_CPP0SEL_PA4,charge[j]);
            ACMP_ENABLE(ACMP,0);
            for(i=0; i<0x50000; i++);
