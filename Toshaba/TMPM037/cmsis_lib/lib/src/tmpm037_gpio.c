...
const uint32_t GPIO_Base[GPIO_NUM] = {
    ...
    TSB_PE_BASE, TSB_PF_BASE, TSB_PG_BASE
};
...
/*        DATA    CR      FR1    FR2    OD     PUP    PDN    IE  */
/* PA */ {0xFFU, 0xFFU, {0x00U, 0x00U}, 0xFFU, 0xFFU, 0xFFU, 0xFFU},
/* PB */ {0xFFU, 0xFFU, {0x0EU, 0x06U}, 0xFFU, 0xFFU, 0xFFU, 0xFFU},
/* PC */ {0x3FU, 0x3FU, {0x3FU, 0x00U}, 0x3FU, 0x3FU, 0x3FU, 0x3FU},
/* PD */ {0x3FU, 0x3FU, {0x1FU, 0x00U}, 0x3FU, 0x3FU, 0x3FU, 0x3FU},
/* PE */ {0xFFU, 0xFFU, {0x1CU, 0x00U}, 0xFFU, 0xFFU, 0xFFU, 0xFFU},
/* PF */ {0xFFU, 0xFFU, {0x3FU, 0x00U}, 0xFFU, 0xFFU, 0xFFU, 0xFFU},
/* PG */ {0xFFU, 0xFFU, {0xFFU, 0x00U}, 0xFFU, 0xFFU, 0xFFU, 0xFFU}
};
...
/**
  ...
  * @param  GPIO_x: Select GPIO port.
  *   This parameter can be one of the following values:
  *   GPIO_PB, GPIO_PC, GPIO_PD, GPIO_PE, GPIO_PF, GPIO_PG.
