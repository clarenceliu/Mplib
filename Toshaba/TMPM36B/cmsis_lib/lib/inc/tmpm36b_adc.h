...
#ifndef __TMPM36B_ADC_H
#define __TMPM36B_ADC_H
...
#define IS_ADC_INPUT_CHANNEL(param)           ((param) <= ADC_AN_15)
#define IS_ADC_SCAN_CHANNEL(start, range)     (((start) <= ADC_AN_15) && \
                                               ((range) >= 1U) && \
                                               (((start) + (range)) <= 16U))
...
#define ADC_EXTERADTRG                  ((uint32_t)0x00U)
#define ADC_INTERTRIGGER                ((uint32_t)0x01U)
...
#define IS_ADC_TRG(param)              ((param) <= ADC_TRG_10)
