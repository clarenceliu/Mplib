...
#define RMCCLK_TB1OUT_SET              ((uint32_t)0x00000001)
...
/**
  ...
  *   This parameter can be one of the following values:
  *   TSB_RMC0
  * @param  RMC_InitStruct: The structure containing the basic RMC configuration.
  * @retval None
  */
...
/**
  ...
  *   This parameter can be one of the following values:
  *   TSB_RMC0
  * @param  LeaderPara: parameters to configure leader detection.
  * @retval None
  */
void RMC_SetLeaderDetection(TSB_RMC_TypeDef * RMCx, RMC_LeaderParameterTypeDef LeaderPara)
{
    ...
    assert_param(IS_RMC_LEADER_PARAMETER
                 (LeaderPara.MaxCycle, LeaderPara.MinCycle,
                  LeaderPara.MaxLowWidth, LeaderPara.MinLowWidth));

    /*Set the parameters to RMCRCR2<RMCLD> register. */
    if (LeaderPara.LeaderDetectionState == ENABLE) {
        ...
        /*Set the parameters to RMCRCR1<RMCLCMAX7:0><RMCLCMIN7:0><RMCLLMAX7:0><RMCLLMIN7:0> register. */
        ...
        /*Set the parameters to RMCRCR2<RMCLIEN> register. */
...
/**
  ...
  *   This parameter can be one of the following values:
  *   TSB_RMC0
  * @param  Method: which method of receiving a remote control signal.
  *   This parameter can be one of the following values:
...
void RMC_SetSignalRxMethod(TSB_RMC_TypeDef * RMCx, RMC_RxMethod Method)
{
    ...
    if (Method == RMC_RX_IN_PHASE_METHOD) {
        /* Set RMCRCR2<RMCPHM> to receive in phase method */
        RMCx->RCR2 |= RCR2_RMCPHM_PHASE;
    } else {
        /* Clear RMCRCR2<RMCPHM> to receive in cycle method */
...
/**
  ...
  *   This parameter can be one of the following values:
  *   TSB_RMC0
  * @param  LowWidth: Excess low width that triggers reception
  *                   completion and interrupt generation.
  * @param  MaxDataBitCycle: Maximum data bit cycle that triggers
...
void RMC_SetRxTrg(TSB_RMC_TypeDef * RMCx, uint8_t LowWidth, uint8_t MaxDataBitCycle)
{
    ...
    /*Set the parameters to RMCRCR2<RMCLL7:0><RMCDMAX7:0> register. */
...
/**
  ...
  *   This parameter can be one of the following values:
  *   TSB_RMC0
  * @param  LargerThreshold: Larger threshold to determine a signal pattern in a phase method,
  *                          which should be less than 0x80
  * @param  SmallerThreshold: Smaller threshold to determine a pattern in a phase method, 
  *                           which should be less than 0x80
  * @retval None
  */
void RMC_SetThreshold(TSB_RMC_TypeDef * RMCx, uint8_t LargerThreshold, uint8_t SmallerThreshold)
{
    ...
    /*Set the parameters to RMCRCR3<RMCDATH6:0><RMCDATL6:0> register. */
...
void RMC_SetInputSignalReversed(TSB_RMC_TypeDef * RMCx, FunctionalState NewState)
{
    ...
    if (NewState == ENABLE) {
        /* Set RMCRCR4<RMCPO> to enable signal reversed */
        RMCx->RCR4 |= RCR4_REVERSE_SET;
    } else {
        /* Clear RMCRCR4<RMCPO> to disable signal reversed */
...
/**
  ...
  *   This parameter can be one of the following values:
  *   TSB_RMC0
  * @param  NoiseCancellationTime: Noise cancellation time,which should be less than 0x10.
  * @retval None
  */
void RMC_SetNoiseCancellation(TSB_RMC_TypeDef * RMCx, uint8_t NoiseCancellationTime)
{
    ...
    /*Set the parameters to RMCRCR4<RMCNC3:0> register for noise cancellation time. */
    temp = RMCx->RCR4;
...
RMC_INTFactor RMC_GetINTFactor(TSB_RMC_TypeDef * RMCx)
{
    ...
    /*Read the interrupt factor infomation from RMCRSTAT<RMCRLIF><RMCLOIF> <RMCDMAX> <RMCEDIF> register. */
    temp = RMCx->RSTAT;
...
RMC_LeaderDetection RMC_GetLeader(TSB_RMC_TypeDef * RMCx)
{
    ...
    /*Read the leader detection result from RMCRSTAT<RMCRLDR> register. */
...
/**
  ...
  *   This parameter can be one of the following values:
  *   TSB_RMC0
  * @param  Reg_x: Select the set register.
  *   This parameter can be one of the following values:
  *   RMC_RX_END_BITS_REG_1, RMC_RX_END_BITS_REG_2 or RMC_RX_END_BITS_REG_3
  * @param  BitNum: Specifies that the number of receive data bit.
  * @retval None
  */
...
/**
  ...
  *   This parameter can be one of the following values:
  *   TSB_RMC0
  * @param  Clk: RMC sampling clock
  *   This parameter can be one of the following values:
  *   RMC_CLK_LOW_FREQUENCY, RMC_CLK_TB1OUT
  * @retval None
  */
void RMC_SetSrcClk(TSB_RMC_TypeDef * RMCx, RMC_SrcClk Clk)
{
    ...
    if (Clk == RMC_CLK_TB1OUT) {
        RMCx->FSSEL |= RMCCLK_TB1OUT_SET;
    } else {
