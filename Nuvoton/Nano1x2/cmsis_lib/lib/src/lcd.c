/******************************************************************************
 * @file     LCD.c
 * @brief    NANO1x2 LCD driver source file.
 ...
 *
 *  @param u32Com      COM number
 *  @param u32Seg       Segment number
 *  @param u32OnFlag   1: segment display
 ...
 *
 *  @param u32OnOff: 1: Enable all segments
 ...
 *
 *  @param u32Count   Frame count value
 *
 *
 ...
 *
 *  @param  u32DrivingType : LCD driving type: LCD_C_TYPE / LCD_EXTERNAL_R_TYPE / LCD_INTERNAL_R_TYPE / LCD_EXTERNAL_C_TYPE
 *  @param  u32ComNum: LCD Com number: 1 ~6
 *  @param  u32BiasLevel: LCD bias level: LCD_BIAS_STATIC / LCD_BIAS_HALF / LCD_BIAS_THIRD
 *  @param  u32FramerateDiv: LCD frequency divider: LCD_FREQ_DIV32 / LCD_FREQ_DIV64 / LCD_FREQ_DIV96 / LCD_FREQ_DIV128 /
 *                                                  LCD_FREQ_DIV192/ LCD_FREQ_DIV256 / LCD_FREQ_DIV384 / LCD_FREQ_DIV512
 *  @param  u32DrivingVol: LCD charge pump driving voltage: LCD_CPVOl_2_6V / LCD_CPVOl_2_7V / LCD_CPVOl_2_8V / LCD_CPVOl_2_9V /
 *                                                          LCD_CPVOl_3V / LCD_CPVOl_3_1V / LCD_CPVOl_3_2V / LCD_CPVOl_3_3V
 *
 ...
 *
 *  @param u32ms Blinking display time(unit: ms).
 *
 ...
 *
 *  @param IntSrc         Interrupt Source: LCD_FRAMECOUNT_INT / LCD_POWERDOWN_INT / LCD_ALL_INT
 *
 *  @return None
 *
 */
