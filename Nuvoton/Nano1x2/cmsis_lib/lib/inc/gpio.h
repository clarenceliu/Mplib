 ...
 * @brief    Nano1x2 series GPIO driver header file
 *
 * @note
 ...
 * @return      None
 *
 * @details     Disable pull-up resistor of specified GPIO pin.
 */
 ...
 * @return      None
 *
 * @details     Enable Pull-up resistor of specified GPIO pin.
 */
